...
#include "ball_track_alvar/Marker.h"
#include "highgui.h"
...
bool Marker::UpdateContentBasic(vector<PointDouble> &_marker_corners_img, IplImage *gray, Camera *cam, int frame_no /*= 0*/) {
	...
	ros_marker_points_img.clear(); // Marker points in image coordinate
...
bool MarkerArtoolkit::DecodeContent(int *orientation) {
	cout << "MarkerArtoolkit::DecodeContent --- 진행 안됨\n";
...
// Decodes the marker content. Please call UpdateContent before this.
